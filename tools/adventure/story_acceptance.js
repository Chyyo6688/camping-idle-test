...
check("旧目标字段安全忽略且历史迁移为 hook", migrated.version === 10 && !("selectedGoal" in migrated) && !("goalProgress" in migrated) && migrated.recentAdventureHistory[0].hookId === "investigateWildlife" && migrated.recentAdventureHistory[0].outcomeType === "continuing", JSON.stringify({ version: migrated.version, history: migrated.recentAdventureHistory }));

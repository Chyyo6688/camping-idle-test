...
check("v5 旧档升级时补雨林状态且保留深山与库存", oldSave.version === 9 && oldSave.storage.fieldLantern === 1 && oldSave.mapStates.deepMountain.bridgeRepaired && oldSave.mapStates.fogRainforest.stationResearchStage === 0 && oldSave.adventureMemories.canopyCrossings === 0 && oldSave.adventureMemories.stationRecordsRecovered === 0 && oldSave.adventureMemories.sharedSymbolEncounters === 0 && oldSave.unlockedMaps.join("|") === "deepMountain", JSON.stringify({ version: oldSave.version, storage: oldSave.storage, maps: oldSave.mapStates, memories: oldSave.adventureMemories, unlockedMaps: oldSave.unlockedMaps }));
